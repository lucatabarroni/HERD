...
####### apriamo e prepariamo i file per il test ########
...
training_sizes.append(sum(electrons_100GeV_1TeV_size)/2)
training_sizes.append(sum(electrons_1TeV_20TeV_size)/2)
training_sizes.append(sum(protons_100GeV_1TeV_size)/2)
training_sizes.append(sum(protons_1TeV_10TeV_size)/2)

def training_file(array_size,limit):
    somma=0
...
final_electrons_100GeV_1TeV_training_file=training_file(electrons_100GeV_1TeV_size,training_sizes[0])
final_electrons_1TeV_20TeV_training_file=training_file(electrons_1TeV_20TeV_size,training_sizes[1])
final_protons_100GeV_1TeV_training_file=training_file(protons_100GeV_1TeV_size,training_sizes[2])
final_protons_1TeV_10TeV_training_file=training_file(protons_1TeV_10TeV_size,training_sizes[3])
...
list_electrons_validation_size=electrons_100GeV_1TeV_size[final_electrons_100GeV_1TeV_training_file:]+electrons_1TeV_20TeV_size[final_electrons_1TeV_20TeV_training_file:]
...
def DataLoader(Batcher,Sequence):
    def __init__(self,
...
######## cariachiamo modello e dati li testiamo ########
...
predictions=model.predict(object)
lists_labels=object.labels

predictions=np.array(predictions)

labels=[]

for batch_list in lists_labels:
    labels.extend(batch_list)
